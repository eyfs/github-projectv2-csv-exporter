        ...
        if (accessToken && login && projectNumber >= 0) {
            ...
            (0, github_projectv2_api_1.fetchProjectItems)(login, !!isOrg, projectNumber, accessToken, progress)
                ...
                const dataRows = projectItems
                    ...
                    const rawDescription = (_c = item.getDescription()) !== null && _c !== void 0 ? _c : '';
                    return {
                        Title: (removeTitleEmojis ? rawTitle.split((0, emoji_regex_1.default)()).join('') : rawTitle).trim(),
                        Number: (_d = item.getNumber()) !== null && _d !== void 0 ? _d : '',
                        Description: (_e = item.getDescription()) !== null && _e !== void 0 ? _e : '',
                        Status: (removeStatusEmojis ? rawStatus.split((0, emoji_regex_1.default)()).join('') : rawStatus).trim(),
                        Assignees: (_g = (_f = item
                            .getAssignees()) === null || _f === void 0 ? void 0 : _f.map((a) => a.name).join(', ')) !== null && _g !== void 0 ? _g : '',
                        'Assignee Usernames': (_j = (_h = item
                            .getAssignees()) === null || _h === void 0 ? void 0 : _h.map((a) => a.login).join(', ')) !== null && _j !== void 0 ? _j : '',
                        Labels: (_l = (_k = item.getLabels()) === null || _k === void 0 ? void 0 : _k.join(', ')) !== null && _l !== void 0 ? _l : '',
                        URL: (_m = item.getUrl()) !== null && _m !== void 0 ? _m : '',
                        Milestone: (_o = item.getMilestone()) !== null && _o !== void 0 ? _o : '',
                        Author: (_q = (_p = item.getAuthor()) === null || _p === void 0 ? void 0 : _p.name) !== null && _q !== void 0 ? _q : '',
                        'Author Username': (_s = (_r = item.getAuthor()) === null || _r === void 0 ? void 0 : _r.login) !== null && _s !== void 0 ? _s : '',
                        CreatedAt: (_t = item.getCreatedAt()) !== null && _t !== void 0 ? _t : '',
                        UpdatedAt: (_u = item.getUpdatedAt()) !== null && _u !== void 0 ? _u : '',
                        ClosedAt: (_v = item.getClosedAt()) !== null && _v !== void 0 ? _v : '',
                        Type: (_w = item.getType()) !== null && _w !== void 0 ? _w : '',
                        State: (_x = item.getState()) !== null && _x !== void 0 ? _x : '',
                    };
                });
